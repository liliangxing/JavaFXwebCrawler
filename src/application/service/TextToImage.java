    ...
    public static void createImage(String[] strArr, Font font,
        ...
        for (int j = 0; j < listStr.size(); j++) {
            ...
            if (length > line_string_num) {
                newList.add(tempStr.substring(0, line_string_num));
                listStr.add(j + 1, tempStr.substring(line_string_num));
                listStr.set(j, tempStr.substring(0, line_string_num));
            } else {
                newList.add(tempStr);
            }
        }
        ...
        for (int m = 0; m < imgNum; m++) {
            String filePath = "E:\\AndroidProject\\E\\dd" + m + ".jpg";
